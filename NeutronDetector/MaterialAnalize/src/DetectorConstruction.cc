...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  // G4Material* polyeth = G4Material::GetMaterial("EJ325");
  G4Material* polyeth = G4Material::GetMaterial("EJ323");
  // G4Material* polyeth = G4Material::GetMaterial("EJ200");
  ...
  G4double detectINXY = 0.7000001*m;
...
void DetectorConstruction::ConstructMaterials()
{
  ...
  mat_ej301->AddElement(elC, fractionmassC*perCent);

  // Liquid EJ325
  density= 0.875*g/cm3; hcratio = 1.73;
  invhcr = 1/hcratio;
  fractionmassH = (hcratio*aH)/(hcratio*aH+aC);
  fractionmassC = (invhcr*aC)/(invhcr*aC+aH);
  G4Material* mat_ej325 = new G4Material("EJ325", density, 2);
  mat_ej325->AddElement(elH, fractionmassH*perCent);
  mat_ej325->AddElement(elC, fractionmassC*perCent);
  ...
  mat_ej323->AddElement(elH, fractionmassH*perCent);
  mat_ej323->AddElement(elC, fractionmassC*perCent);
  ...
  mat_ej200->AddElement(elH, fractionmassH*perCent);
  mat_ej200->AddElement(elC, fractionmassC*perCent);
