 ...
 #ifndef ParameterisationSphere_H
 #define ParameterisationSphere_H 1
 ...
 {
  public:
    ChamberParameterisation(G4int n, std::vector<G4Material*>& mat, G4double radius, G4double detXY, G4double tarDist, G4bool XorY);
