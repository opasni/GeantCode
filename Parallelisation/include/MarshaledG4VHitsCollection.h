...
G4VHitsCollection* unmarshal() {
    ...
    if(msh_size <= MSH_HEADER_SIZE) {
        ...
        {
        param = new G4THitsCollection<HadCalorimeterHit>("","");
        }
        this->Shadowed_param = (ShadowedMarshaledG4VHitsCollection*)this->param;
...
void marshal3() {
    ...
    //Now just copy "get" functions here
    {
      G4THitsCollection<HadCalorimeterHit> *aObj293 = (G4THitsCollection<HadCalorimeterHit>*)param;
      MarshaledG4THitsCollection<HadCalorimeterHit> marChild(aObj293);
...
void unmarshal3() {
    ...
    //Now copy the setspec here
    {
      MarshaledG4THitsCollection<HadCalorimeterHit> marObj(msh_cursor);
      marObj.unmarshalTo((G4THitsCollection<HadCalorimeterHit>*)param);
